...
if __name__ == "__main__":
    # setting up the cp path and the model dict
    checkpoint_path = 'python/{}.ckpt'
    gens = {"christmas": TextGenerator(), "birthday": TextGenerator(), "luck": TextGenerator(), "getWell": TextGenerator(), "anniversary": TextGenerator()}
    # FOR DEV USE:
    # tag = "christmas"
